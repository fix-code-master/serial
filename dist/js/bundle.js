...
function form(triggerSelector, modalSelector, timerId, form, modalDialog) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (event) {
      ...
      (0,_server_server__WEBPACK_IMPORTED_MODULE_10__["default"])('http://localhost:3000/request', Object.fromEntries(formData.entries())).then(function () {
  ...
  function showThanksModal(msg) {
    var prevDialogModal = document.querySelector(modalDialog);
    prevDialogModal.classList.add('hide');
    (0,_modal__WEBPACK_IMPORTED_MODULE_9__.openModal)(triggerSelector, modalSelector, timerId);
    ...
    setTimeout(function () {
      thanksModal.remove();
      (0,_modal__WEBPACK_IMPORTED_MODULE_9__.closeModal)(modalSelector);
...
function modal(triggerSelector, modalSelector, timerId) {
  ...
  modalTrigger.addEventListener('click', function () {
    return openModal(modalSelector, timerId);
  });
  ...
  document.addEventListener('keydown', function (event) {
    if (event.code === 'Escape' && modal.classList.contains('show')) closeModal(modalSelector);
  });
...
function slider(_ref) {
  ...
  next.addEventListener('click', function () {
    ...
    dots.forEach(function (dot) {
      return dot.style.cssText = "background-color: rgb(101, 176, 252); border: none;";
    });
    dots[slideIndex - 1].style.cssText = "background-color: transparent; border: 2px solid white;";
  });
...
function tab(tabsParentSelector, tabsContentSelector, tabsSelector, activeSelector) {
  ...
  var tabsCotainer = document.querySelector(tabsParentSelector),
    tabsContent = document.querySelectorAll(tabsContentSelector),
    tabs = document.querySelectorAll(tabsSelector);
  // Tabs
  tabsCotainer.addEventListener('click', function (event) {
  ...
  function hideTabContent() {
    ...
    tabs.forEach(function (tab) {
      return tab.classList.remove(activeSelector);
    });
  }
...
function time(deadline, id) {
  ...
  function getZero(num) {
    if (num >= 0 && num < 10) return "0".concat(num);else return num;
  }
  function setClock(selector, endtime) {
    ...
    function updateClock() {
      var getTime = getTimeRemaining(endtime);
      if (getTime.days <= 0) {
...
/* harmony import */ var _modules_time__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../modules/time */ "./src/modules/time.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var timerId = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_4__.openModal)('.modal', timerId);
  }, 3000);
  // console.log(setTimeout(() => openModal('.modal', timerId), 3000)) // output 2
  (0,_modules_card__WEBPACK_IMPORTED_MODULE_1__["default"])();
  (0,_modules_form__WEBPACK_IMPORTED_MODULE_2__["default"])('[data-modal]', '.modal', timerId, 'form', '.modal__dialog');
  (0,_modules_loader__WEBPACK_IMPORTED_MODULE_3__["default"])('.loader');
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_4__["default"])('[data-modal]', '.modal', timerId);
  ...
  (0,_modules_tab__WEBPACK_IMPORTED_MODULE_6__["default"])('.tabheader__items', '.tabcontent', '.tabheader__item', 'tabheader__item_active');
  (0,_modules_time__WEBPACK_IMPORTED_MODULE_7__["default"])('2023-6-26', '.timer');
  // server()
});
})();
